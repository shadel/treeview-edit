...
import { ISDAChoice, ISDAOptionCheckbox, SDAOptionType } from '../type'
import {
  FIExtractTreeFunc,
...
const OPTION_TYPE = SDAOptionType.CHECKBOX
...
function Component({ task, ...props }: OptionProps) {
  ...
  const option = task.properties.option as ISDAOptionCheckbox
