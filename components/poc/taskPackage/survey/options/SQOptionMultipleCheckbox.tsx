...
import { ISQCheckbox, ISQOptionMultipleCheckbox, SQOptionType } from '../type'
import { FICreateOptionFunc, FIOptionComponentFunc, OptionProps } from './hepler'
import { SQCheckbox } from './SQCheckbox'

const OPTION_TYPE = SQOptionType.MULTIPLE_CHECKBOX
...
function Component({ task, ...props }: OptionProps) {
  const option = task.properties.option as ISQOptionMultipleCheckbox
